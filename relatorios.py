...
def gerar_relatorios(df, nome_arquivo="Relatorio_Completo.xlsx"):
    mapa_categorias = {
        ...
        "Repasse": "Repasse",
        "Participação em contrato": "Repasse",         # CORRIGIDO
        "Folha de pagamento": "Folha",                 # CORRIGIDO
        "Diversos": "Outras Receitas",                 # CORRIGIDO
    ...
    saldo_inicial_por_banco = (
        ...
        .groupby("Conta Financeira")["Valor"]
        .sum()
        .reset_index()
    ...
    colunas_existentes = [c for c in colunas if c in bancos_pivot.columns]
    bancos_pivot = bancos_pivot[colunas_existentes]
