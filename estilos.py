def aplicar_estilos(workbook, writer, dre_operacional, destinacao, resumo, despesas_detalhadas, conciliacao, bancos_pivot):
    ...
    # ===== Estilos para Bancos =====
    # CORRIGIDO: coluna "Saldo (R$)" renomeada para "Saldo Final (R$)"
    ...
    for row_num in range(1, len(bancos_pivot)+1):
        ...
        ws_bancos.write(row_num, 1, saldo_inicial, saldo_format)
        ws_bancos.write(row_num, 2, entradas, entrada_format)
